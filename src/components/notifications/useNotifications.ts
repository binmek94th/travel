...
// src/components/notifications/useNotifications.ts + NotificationBell.tsx
// Split into two exports from this file for convenience.
...
export function useNotifications(userId: string | null | undefined) {
    ...
    useEffect(() => {
        ...
        const unsub = onSnapshot(q, snap => {
            ...
            // Detect brand-new unread docs (not seen before) → show toast
            docs.forEach(n => {
