...
export default function TourDetail({
    ...
    // Days that have coordinates — used to show/hide the route map
            ...
            <div className="mx-auto max-w-6xl px-6 py-12">
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-10">
                        ...
                        {/* ── ROUTE MAP — shown above itinerary if days have coords ── */}
                        {mappedDays.length >= 2 && (
                            <section>
                            ...
                            <section>
                                    ...
                                    {tour.itinerary.map((day, i) => {
                                        ...
                                        return (
                                            <div key={i} className="overflow-hidden rounded-xl border border-[rgba(14,133,178,0.10)]">
                                                {/* Transport mode connector (between days) */}
                              ...
                              {TRANSPORT_ICONS[day.transportMode]} {day.transportMode}
                                                ...
                                                <button type="button" onClick={()=>setActiveDay(activeDay===i?null:i)}
                                                    ...
                                                    <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#28B8E8] to-[#0A6A94] text-xs font-bold text-white">
                                                        {i+1}
                                                    </div>
                ...
                <span className="text-3xl font-bold text-[#0A3D52]" style={{ fontFamily:"'Playfair Display',serif" }}>
                  ${tour.priceUSD.toLocaleString()}
                            ...
                            <p className="text-center text-xs font-light text-[#1A6A8A]">No payment required to reserve</p>
                        </div>
