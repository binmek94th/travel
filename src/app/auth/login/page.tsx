  ...
  return (
      <>
        <div className="tab-pills">
          <Link href={`/auth/login?returnUrl=${encodeURIComponent(returnUrl)}`}  className="pill active">Sign in</Link>
          <Link href={`/auth/signup?returnUrl=${encodeURIComponent(returnUrl)}`} className="pill">Create account</Link>
        </div>
        ...
        <div className="card">
          ...
          <p className="form-footer">
            No account yet?{" "}
            <Link href={`/auth/signup?returnUrl=${encodeURIComponent(returnUrl)}`} className="form-link">Create one</Link>
          </p>
        </div>
